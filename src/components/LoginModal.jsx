    ...
    <div className="login-overlay" onClick={onClose}>
      <div className="login-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="login-content">
          ...
          <p className="login-subtitle">Sign in to access editor mode</p>
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
              <path d="M17.64 9.20454C17.64 8.56636 17.5827 7.95272 17.4764 7.36363H9V10.845H13.8436C13.635 11.97 13.0009 12.9232 12.0477 13.5614V15.8195H15.9564C17.4382 14.2527 18.18 11.9454 18.18 9.20454H17.64Z" fill="#4285F4"/>
